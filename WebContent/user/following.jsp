		...
		<div class="row row-offcanvas row-offcanvas-left">
			<div class="col-md-2 sidebar-offcanvas hidden-xs hidden-sm"
				...
				<div class="list-group">
					...
					<a href=" ${pageContext.request.contextPath }/user/showMyAttention.action" class="list-group-item current">我的关注的问题</a>
				</div>
			</div>
				...
				<table class="table table-striped">
					...
					<tbody>
						...
						<c:forEach items="${attentions}" var="attention">
							...
							<tr>
								<th scope="row">${attention.getNum() }</th>
								<td><a href="#">${attention.getTitle() }</a></td>
								<td>${attention.getAttenNum() }人关注</td>
								<td>${attention.getReadNum() }次浏览</td>
								<td>${attention.getAnsNum() }个回答</td>
							</tr>

						</c:forEach>
						<c:forEach items="${attentions1}" var="attention1">

							<tr>
								<th scope="row">${attention1.getNum() }</th>
								<td><a href="#">${attention1.getTitle() }</a></td>
								<td>文章</td>
								<td>${attention1.getAttenNum() }人关注</td>
								<td>${attention1.getReadNum() }次浏览</td>
								<td>${attention1.getAnsNum() }个评论</td>
							</tr>
