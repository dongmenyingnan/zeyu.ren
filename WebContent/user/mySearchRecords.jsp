		...
		<div class="row row-offcanvas row-offcanvas-left">
			<div class="col-md-2 sidebar-offcanvas hidden-xs hidden-sm"
				...
				<div class="list-group">
					...
					<a href=" ${pageContext.request.contextPath }/user/mySearchRecords.action" class="list-group-item current">我的搜索记录</a> 
					...
					<tbody>
						...
						<c:forEach items="${historys}" var="history">
							...
							<tr>
								...
								<td>${history.history_kind }</td>
								<td><a href="#">${history.history_key }</a></td>
							</tr>
