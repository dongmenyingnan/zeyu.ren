		...
		<div class="row row-offcanvas row-offcanvas-left">
			<div class="col-md-2 sidebar-offcanvas hidden-xs hidden-sm"
				...
				<div class="list-group">
					<a href="aboutus.jsp" class="list-group-item list-group-item-success">关于我们</a>
					<a href="duty.jsp" class="list-group-item">服务条款</a>
					<a href="feedback.jsp" class="list-group-item">建议反馈</a>
				</div>
			</div>
			<div class="col-md-9">
				<article class="post page">
					<section class="post-content">
						<span id="toc0"></span>
						<h2 id="-">关于我们</h2>
						<p>Exception -- 创建于2016年。起因是许多同学遇到问题无从下手，因此我们对Java
							Web的相关知识进行了整理，方便同学们在开发，学习的时候能学习到知识，解决问题</p>
						<span id="toc1"></span>
						<h2 id="-bootstrap-">分享你的开发经验</h2>
						<p>你是一位攻城狮吗？你正在用Java Web做开发吗？你开发的网站遇到了什么问题吗？那就把你的解决方案show出来吧！</p>
						<p>凡是经过确认审核通过的解决方案，我们会将你所提交方案分享及介绍展示到“优秀方案”列表中，并有机会在 Exception
							的首页进行推荐。</p>
						<blockquote style="border-left: 5px solid #C7C7C7;">
							<p>
								请注册成为我们的会员，并将自己优秀的解决方案发步上来；或发邮件到下面的邮箱，并在邮件标题上注明（优秀解决方案 -- 具体内容）。<br>Mail：
								cs-zy-leo@hotmail.com
							</p>
						</blockquote>
						<span id="toc2"></span>
						<h2 id="-">加入我们</h2>
						<p>Exception坚持分享、开放的互联网精神，旨在为广大攻城师、设计师提供解决问题，交流问题的平台，如果你和我们有相同的目标，我们乐意一起携手前行。</p>
						<p>如果你也热爱开发、热爱分享，有一颗创业的心，欢迎和我们联系，更欢迎你加入我们的团队！</p>
						<p>QQ: 609191920 Mail: cs-zy-leo@hotmail.com</p>
