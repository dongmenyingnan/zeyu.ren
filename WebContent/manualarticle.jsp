		...
		<div id="top">
			<div id="topleft">
				<div>
					...
					<h3>${manualarticle.manualartcle_title}</h3>
				</div>
				<div style="margin-top: 10px;">
					<a class="black fs-16 ml-40" href="#">${manualarticle.maualartcle_author}</a> <span
						class="fs-14" style="margin-left: 20px;">${manualarticle.create_time}
						发表</span>
				</div>
			</div>
		<%-- 	<div id="topright">
		...
		<div id="center">
			<div id="leftpart">
				<div id="qbody">
					...
					<p>
					${manualarticle.manualartcle_content}
					</p>
					 </div>
				...
				<span style="margin-right: 10px;"><fmt:formatDate type="both" 
				value="${manualarticle.maualartcle_time }" pattern="yyyy-MM-dd hh:mm:ss" /></span>
				</div>
				</div>
					</div>
				<%-- <div id="abody">
